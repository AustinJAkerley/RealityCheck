/**
 * RealityCheck Edge Extension — Offscreen Document
 *
 * Runs Transformers.js / ONNX Runtime inference in a full DOM context.
 * Edge MV3 service workers (same Chromium engine) forbid dynamic import()
 * and WASM, so the background service worker creates this offscreen document
 * and forwards SDXL_CLASSIFY requests here.
 *
