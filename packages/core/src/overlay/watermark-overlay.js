...
function positionWatermark(el, wrapper, position) {
 ...
 */
function shouldAutoFallback(element, config) {
...
function effectiveMode(element, config) {
 ...
 */
export function applyMediaWatermark(media, confidence, config) {
    injectStyles();
 ...
 */
export function applyTextWatermark(element, confidence, _config) {
    injectStyles();
...
//# sourceMappingURL=watermark-overlay.js.map